...
export const MessageInput: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <div className="ai-input-lines bg-slate-100/90 dark:bg-slate-800/60 rounded-xl p-6 border border-slate-200/60 dark:border-slate-700/30 backdrop-blur-sm shadow-2xl w-full">
