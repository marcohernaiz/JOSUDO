        ...
        <div className="flex items-center space-x-4">
          {!isAuthenticated ? (
            <Button 
              ...
              className="bg-white dark:bg-slate-700 hover:bg-gray-100 dark:hover:bg-slate-600 text-gray-900 dark:text-white border border-gray-300 dark:border-slate-600 shadow-sm px-6 py-2 rounded-lg flex items-center space-x-2 transition-all duration-200"
            >
