        ...
        <div className="flex items-center space-x-4">
          {!isAuthenticated ? (
            <Button 
              ...
              className="bg-white hover:bg-gray-100 text-gray-900 border border-gray-300 shadow-sm px-6 py-2 rounded-lg flex items-center space-x-2 transition-all duration-200"
            >
