...
export const Sidebar: React.FC<SidebarProps> = ({ onClose }) => {
  ...
  return (
    <>
      <div 
        className={`h-full bg-slate-600 dark:bg-slate-900/80 border-r border-slate-500 dark:border-slate-700 flex flex-col transition-all duration-75 ${
      ...
      >
        {/* Header */}
        <div className="p-4 border-b border-slate-500 dark:border-slate-700">
