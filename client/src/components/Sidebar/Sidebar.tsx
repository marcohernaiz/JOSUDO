  ...
  return (
    <>
      ...
      >
        ...
        {isAuthenticated && (
          <div
            className={`${isExpanded ? "p-4" : "p-2"} border-t border-slate-300 dark:border-slate-700`}
          >
            <div className={`${isExpanded ? "space-y-3" : "space-y-2"}`}>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="start" className="w-48">
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      window.open("https://josudo.com/learn", "_blank")
                    }
                    className="cursor-pointer"
                  >
                    ...
                    <div className="gsi-material-button-content-wrapper">
                      <div className="gsi-material-button-icon">
                        ...
                        >
                          ...
                          <path
                            fill="#4285F4"
                            d="M46.98 24.55c0-1.57-.15-3.09-.38-4.55H24v9.02h12.94c-.58 2.96-2.26 5.48-4.78 7.18l7.73 6c4.51-4.17 7.09-10.36 7.09-17.65z"
                          ></path>
                          <path
                            fill="#FBBC05"
